package com.danielpobre.maironmurvil.control;
...
public class DispositivBT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dispositiv_bt);
    }
    ...
    public void onResume()
    {
        ...
        mPairedDevicesArrayAdapter = new ArrayAdapter(this, R.layout.nombre_dispositivs);//<-<- PARTE A MODIFICAR >->->
        ...
        {
            for (Object device : pairedDevices) { //EN CASO DE ERROR LEER LA ANTERIOR EXPLICACION
                mPairedDevicesArrayAdapter.add(mBtAdapter.getName() + "\n" + mBtAdapter.getAddress());
            }
        }
    }
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(DispositivBT.this, MainActivity.class);//<-<- PARTE A MODIFICAR >->->
